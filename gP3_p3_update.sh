...
# Version and md5sum
#
FIRMWARE_URL="https://ghproxy.com/https://raw.githubusercontent.com/niceboygithub/AqaraM1SM2fw/main"
VERSION="4.0.2_0024.0644"
COOR_MD5SUM="d65dcc9dd8255f9b78aaf69c5e9734f7"
KERNEL_MD5SUM="24071bdad891c4cb0d208d941fcc15be"
ROOTFS_MD5SUM="49782a64477b11d5836ea671197063dd"
MODIFIED_ROOTFS_MD5SUM="5aa02283d895cedfdaa1d401689a2a28"
BTBL_MD5SUM=""
BTAPP_MD5SUM=""
IRCTRL_MD5SUM="4c8209564354944f2f7fdb12efd09db8"
...
usage_helper()
{
    ...
    green_echo "Usage: p3_update.sh -h [$OPTIONS]."
}
...
initial()
{
    ...
    if [ "$product" != "lumi.aircondition.acn05" ]; then
        red_echo "This is not supported P3 and exit!"
        exit 1
    fi
}
